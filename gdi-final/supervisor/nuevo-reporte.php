...
<div class="contenido-reporte">
    <form action="" method="POST">
        ...
        <button type="submit" class="btn-comun ">Registrar</button>
       
    </form>
    <button type="submit" class="btn-comun" onclick="window.location.href='detalle-reporte.php'">Continuar</button>
